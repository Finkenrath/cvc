/****************************************************
 * pi_N_2_pi_N_sequential_v4.c
 *
 * Mon Jan 16 16:13:37 EET 2012
 *
 * PURPOSE:
 * - calculate full pion-nucleon to pi-nucleon correlation
 * TODO:
 * DONE:
 *
 ****************************************************/
...
#else
  fprintf(stdout, "[pi_N_2_pi_N_sequential_v4] Warning; resetting global thread number to 1\n");
  g_num_threads = 1;
#endif
