...
extern t_smear_bitmask smear_bitmask_array[4];
extern t_smear_string smear_string_array[4];
 ...
 * 1) text in the input file: LL, LS, SL and SS (sink-source)
...
t_smear_bitmask smear_index_to_bitmask( t_smear_index i_smear_index );
t_smear_cmi_int smear_index_to_cmi_int( t_smear_index i_smear_index );
t_smear_string smear_index_to_string( t_smear_index i_smear_index );
...
t_smear_bitmask smear_cmi_int_to_bitmask( t_smear_cmi_int i_smear_cmi_int );
t_smear_string smear_cmi_int_to_string( t_smear_cmi_int i_smear_cmi_int );
