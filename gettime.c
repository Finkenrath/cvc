...
# include<config.h>
#endif
/* currently, clock_gettime is not supported in CVC 
...
#  include <bits/time.h>
#endif
* curently, clock_gettime is not supported in CVC*/ 
#include <time.h>
...
// clock_gettime is currently not supported in CVC
...
// clock_gettime is currently not suppoerted in CVC
